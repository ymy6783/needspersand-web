...
export default function Footer() {
  return (
    <footer className="relative border-t bg-neutral-50">
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mt-8 border-t border-neutral-200 pt-8">
          ...
          <p className="mt-4 text-center text-sm text-neutral-500">
            © {new Date().getFullYear()} Needspersand. All rights reserved.
          </p>
        </div>
      </div>
      ...
      <Link
        href="/admin/login"
        className="absolute bottom-4 right-6 flex h-9 w-9 items-center justify-center rounded-full text-neutral-400 transition-colors hover:bg-neutral-200 hover:text-neutral-600"
        aria-label="관리자 로그인"
      >
        <svg
